...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textAct = (TextView) findViewById(R.id.text_act);
...
//            s = results[0];
    ...
    private final BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if(SensorService.BROADCAST_SENSOR_RESULT.equals(action)) {
                final String[] sensor_result = intent.getStringArrayExtra(SensorService.EXTRA_SENSOR_RESULT);
//                Log.d("Test", sensor_result[0] + " " + sensor_result[1]);
                textAct.setText(sensor_result[0]);
                textGender.setText(sensor_result[1]);
    ...
    private static IntentFilter makeIntentFilter() {
        ...
        intentFilter.addAction(SensorService.BROADCAST_SENSOR_RESULT);
        return intentFilter;
    }
